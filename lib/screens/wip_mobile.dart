...
class WIP_Mobile extends StatelessWidget {
  const WIP_Mobile({Key? key}) : super(key: key);
                      ...
                      child: Column(
                        ...
                        children: [
                          Text(
                            "Rohan Patil",
                            style:
                            TextStyle(fontSize: 42.0, fontWeight: FontWeight.w600,color: Colors.white),
                          ),
                          Text(
                            "Mobile App Developer",
                            textAlign: TextAlign.center,
                            style:
                            TextStyle(fontSize: 16.0, fontWeight: FontWeight.w600,color: Colors.white70),
                          ),
                          SizedBox(
                            height: 24.0,
                          ),
